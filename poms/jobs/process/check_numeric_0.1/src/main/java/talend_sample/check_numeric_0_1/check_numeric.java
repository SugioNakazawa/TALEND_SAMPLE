 ...
 */
    ...
    class RowSetValueUtil_tSchemaComplianceCheck_1 {
        ...
        void setRowValue_0(row1Struct row1) {
            ...
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"no:");
            errorMessageThrough = "";
    ...
    if (row1.newColumn != null){
        ...
        errorMessageThrough += errorMessage;
            ...
            resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
            errorCodeThrough = 0;
            resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"newColumn:");
            errorMessageThrough = "";
        }
    }
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/Users/nakazawasugio/talend/wks/TALEND_SAMPLE/testdata/check_numeric/commondata.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/Users/nakazawasugio/talend/wks/TALEND_SAMPLE/testdata/check_numeric/commondata.csv", "ISO-8859-15",",","\n",true,0,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"newColumn", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
///////////////////////		
	    		...
	    		if(row2.newColumn != null) { //              
                 row_tLogRow_1[1]=    						
								row2.newColumn.setScale(1, java.math.RoundingMode.HALF_UP).toPlainString()
					          ;	
...
///////////////////////		
	    		...
	    		if(row3.newColumn != null) { //              
                 row_tLogRow_2[1]=    						
								row3.newColumn.setScale(1, java.math.RoundingMode.HALF_UP).toPlainString()
					          ;	
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/Users/nakazawasugio/talend/wks/TALEND_SAMPLE/testdata/check_numeric/commondata.csv") instanceof java.io.InputStream)){
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = "/Users/nakazawasugio/talend/wks/TALEND_SAMPLE/testdata/check_numeric/commondata.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited("/Users/nakazawasugio/talend/wks/TALEND_SAMPLE/testdata/check_numeric/commondata.csv", "ISO-8859-15",",","\n",true,0,0,
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"newColumn", "row4", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'newColumn' in 'row4' connection, value is invalid or this column should be nullable or have a default value."));
...
if(row4 != null) { 
	...
	if (!rsvUtil_tSchemaComplianceCheck_2.ifPassedThrough) {
		...
		row6.errorCode = String.valueOf(rsvUtil_tSchemaComplianceCheck_2.resultErrorCodeThrough);
...
///////////////////////		
	    		...
	    		if(row5.no != null) { //              
                 row_tLogRow_3[0]=    						    
				                String.valueOf(row5.no)			
					          ;	
							
	    		} //			
    			              
                 row_tLogRow_3[1]=    						    
				                String.valueOf(row5.newColumn)			
					          ;	
...
///////////////////////		
	    		...
	    		if(row6.no != null) { //              
                 row_tLogRow_4[0]=    						    
				                String.valueOf(row6.no)			
					          ;	
							
	    		} //			
    			              
                 row_tLogRow_4[1]=    						    
				                String.valueOf(row6.newColumn)			
					          ;	
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = check_numeric.class.getClassLoader().getResourceAsStream("talend_sample/check_numeric_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = check_numeric.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : check_numeric");
        }
...
/************************************************************************************************
 *     103487 characters generated by Talend Open Studio for Data Integration 
 *     on the 2023年3月10日 17:51:08 JST
 ************************************************************************************************/